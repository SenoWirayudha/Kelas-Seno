...
<body>
    ...
    <header class="bg-dark text-white py-3">
        ...
        <h2>Visi dan Misi</h2>
        <p>Visi kami adalah menjadi pemimpin dalam industri ini dengan inovasi dan kualitas terbaik.</p>
        <p>Misi kami adalah memberikan layanan yang memenuhi kebutuhan pelanggan dengan profesionalisme.</p>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Posisi: CEO</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Posisi: CTO</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Posisi: CMO</p>
                    </div>
                </div>
            </div>
        </div>
